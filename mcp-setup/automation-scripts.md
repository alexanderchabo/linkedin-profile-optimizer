# LinkedIn MCP Automation Scripts

Pre-built workflows and automation commands for common LinkedIn optimization tasks.
...
```markdown
### Weekly LinkedIn Profile Health Check
...
4. ✅ Recommendations freshness (latest one's date)
...
```markdown
### Monthly LinkedIn Optimization Report
...
- 3 strategic improvements to profile
```
...
1. **Job Analysis**
   - Get full job details from LinkedIn
   - Extract required vs preferred qualifications
   - Identify company priorities from description language
   - Note specific keywords used

2. **Company Research**
   - Get company profile: [Company URL]
   - Recent posts (last 30 days) - what's their focus?
   - Employee count and growth indicators
   - Culture signals from content

3. **My Match Analysis**
   - Get my LinkedIn profile: [My Profile URL]
   - Calculate match percentage
   - List matching qualifications (with examples from my experience)
   - Identify gaps and how to address them

4. **Application Materials**
   Generate:
   - 7 resume bullet points (achievement-focused)
   - 3-paragraph cover letter framework
   - Customized LinkedIn message to recruiter
   - 5 intelligent questions for interview

5. **Interview Prep**
   - Company's recent achievements to mention
   - Industry challenges they're likely facing
   - How my experience addresses their needs
...
- 2 achievement/project highlights

**Posting Schedule**:
| Week | Mon/Tue | Wed/Thu | Fri/Sat | Theme |
|------|---------|---------|---------|-------|
| 1 | | | | |
| 2 | | | | |
| 3 | | | | |
...
1. **Posting Patterns**
   ...
   - Optimal posting times (if discernible)
   - Engagement metrics patterns

2. **Content Themes**
   - Topics covered (categorize)
   - Personal vs professional content ratio
   - Media types (text, images, video, polls)
...
4. **Differentiation Opportunities**
   - Topics they don't cover that I could
   - Unique angles I can take
...
**Target Role**: [Your current or desired role]
...
1. **Calendar Reminders**:
   - Weekly: Monday 9 AM - Profile health check
   - Monthly: First Monday - Deep optimization
   - Quarterly: Last week of quarter - Performance review

2. **Template Usage**:
   - Copy script to conversation with Claude
   - Replace bracketed placeholders with your data
   - Save results in `/analytics/` folder

3. **Progress Tracking**:
   - Keep a changelog of updates made
   - Track metrics over time
   - Document what works

4. **Batch Processing**:
   - Run multiple analyses in one session
   - Save outputs for review later
   - Implement changes in focused sessions
...
4. Start with the Weekly Health Check this Monday!
